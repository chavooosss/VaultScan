...
def test_claude_provider_dispatches_to_anthropic():
    ...
    mock_claude.assert_called_once_with("x = 1", "otomatik tespit", "sk-claude")
...
def test_explicit_gemini_provider_dispatches_to_gemini():
    ...
    mock_gemini.assert_called_once_with("x = 1", "otomatik tespit", "sk-gemini")
...
def test_analyze_multi_dispatches_by_provider():
    ...
    mock_multi.assert_called_once_with(files, "sk-gpt")
